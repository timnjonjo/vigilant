...
public class DevDataSeeder implements CommandLineRunner {
    ...
    private void seedOrganic(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "org-ref", "dev-org-ref", "197.232.10.1", IpType.RESIDENTIAL, at);
    ...
    private void seedFanoutBurst(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "fan-ref", "dev-fan-ref", "41.80.1.1", IpType.RESIDENTIAL, at);
        for (int i = 1; i <= 9; i++) {
    ...
    private void seedSharedDeviceCluster(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "dev-ref", "dev-dev-ref", "105.20.5.1", IpType.RESIDENTIAL, at);
        for (int i = 1; i <= 4; i++) {
    ...
    private void seedCycle(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, "LOOB-CYCLE-02", "cyc-a", "dev-cyc-a", "196.201.1.10", IpType.RESIDENTIAL, at);
        referrer(campaign, "LOOB-CYCLE-02-B", "cyc-b", "dev-cyc-b", "196.201.2.10", IpType.RESIDENTIAL, at.plusSeconds(60));
        referrer(campaign, "LOOB-CYCLE-02-C", "cyc-c", "dev-cyc-c", "196.201.3.10", IpType.RESIDENTIAL, at.plusSeconds(120));
    ...
    private void seedMultiEdgeOverlap(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "ov-ref", "dev-ov-ref", "3.5.140.1", IpType.DATACENTER, at);
        for (int i = 1; i <= 4; i++) {
    ...
    private void seedViralBusinessContrast(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "viral-kibanda", "dev-viral-owner", "41.70.1.1", IpType.RESIDENTIAL, at);
        for (int i = 1; i <= 10; i++) {
    ...
    private void seedHouseholdContrast(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "household-ref", "dev-household-ref", "105.30.1.1", IpType.RESIDENTIAL, at);
    ...
    private void seedFriendsCycleContrast(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, "LOOB-FRIEND-A", "friend-a", "dev-friend-a", "196.10.1.1", IpType.RESIDENTIAL, at);
        referrer(campaign, "LOOB-FRIEND-B", "friend-b", "dev-friend-b", "196.10.2.1", IpType.RESIDENTIAL, at);
    ...
    private void seedChurnContrast(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "churn-ref", "dev-churn-ref", "154.80.1.1", IpType.RESIDENTIAL, at);
    ...
    private void seedCorporateVpnContrast(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "employee-ref", "dev-employee-ref", "197.220.1.1", IpType.RESIDENTIAL, at);
    ...
    private void seedCrossCampaignOverlap(Instant now, CampaignId active, CampaignId ended) {
        ...
        referrer(ended, "LOOB-CROSS-B", "cross-ref", "dev-cross-ref", "41.200.1.1", IpType.RESIDENTIAL, endedAt);
        redeem(ended, "LOOB-CROSS-B", "cross-b", "cross-shared-device", "41.200.20.3", IpType.RESIDENTIAL, endedAt.plusSeconds(60));
        referrer(active, "LOOB-CROSS-A", "cross-ref", "dev-cross-ref", "41.200.1.1", IpType.RESIDENTIAL, activeAt);
    ...
    private void seedResolvedFalsePositive(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "fp-ref", "dev-fp-ref", "41.90.7.1", IpType.RESIDENTIAL, openedAt);
        for (int i = 1; i <= 3; i++) {
    ...
    private void seedResolvedConfirmedFraud(Instant now, CampaignId campaign) {
        ...
        referrer(campaign, code, "tp-ref", "dev-tp-ref", "62.8.90.1", IpType.RESIDENTIAL, openedAt);
        for (int i = 1; i <= 3; i++) {
    ...
    private void referrer(CampaignId campaign, String code, String userId, String deviceId,
                          String ip, IpType ipType, Instant at) {
        graphStore.registerReferrer(new ReferrerRegistration(
                TENANT, campaign, userId, deviceId, ip, ReferralCode.of(code), at, ipType));
    }
